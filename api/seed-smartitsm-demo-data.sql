...
BEGIN TRY
    ...
    VALUES
        ...
        (9, 'Request for dual monitor setup', 'Need two monitors for campaign analytics and ad ops.', 0, 5, 1, DATEADD(day, -6, GETUTCDATE()), NULL, DATEADD(day, 4, GETUTCDATE()), 9, NULL, 4),
    ...
    VALUES
        (1, 3, 1, 0, NULL, DATEADD(day, -8, GETUTCDATE()), NULL),
        (2, 9, 1, 2, 'Rejected due to budget freeze for non-essential peripherals this month.', DATEADD(day, -6, GETUTCDATE()), DATEADD(day, -5, GETUTCDATE()));
    ...
    VALUES
        (1, 1, 'Approval needed for Adobe Illustrator license request.', 0, 0, 3, DATEADD(day, -8, GETUTCDATE())),
        ...
        (11, 1, 'Approval request rejected for ticket #9.', 1, 1, 9, DATEADD(day, -5, GETUTCDATE())),
    ...
    VALUES
        ...
        (5, 'Approved hardware swap request', 1, DATEADD(day, -16, DATEADD(hour, 1, GETUTCDATE()))),
    ...
    -- Manual Rejection Log for Ticket #9 (Demo rejection reason)
    INSERT INTO AuditLogs (TicketId, Action, UserId, Timestamp)
    VALUES (9, 'Ticket Rejected by Manager. Reason: Rejected due to budget freeze for non-essential peripherals this month.', 1, DATEADD(day, -5, GETUTCDATE()));
